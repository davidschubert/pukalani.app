...
| [plans/BRAND-BOOK-KIT.md](plans/BRAND-BOOK-KIT.md) | Brand Book & Kit (Produkt 03, BK1): **Strategie freigegeben 2026-09-09** (acht Entscheidungen in §1.11: ein Produkt, dritte Schicht in `brand`, DTCG-Kit mit `brand.md`/`brand.json`, BS1-Einmalpreis 149 € netto) — Konzeption (§2) wartet auf Davids Startwort |
