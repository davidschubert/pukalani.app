...
| F47 | 5 — Klicks | **Analytics v2, Rest = nur noch Plausible-UI-Klicks** (Adblock-Proxy live seit 2026-08-12 → COMPLETE): (1) Goals der sieben Trichter-Ereignisse je Site WÖRTLICH anlegen (`funnel_cta_start` …, CE hat keine Goals-API), (2) E-Mail-Reports je Site aktivieren, (3) Entscheidung Kundenbereich-Messung (eigene Site vs. Sammel-Site — fünf der sieben Ereignisse laufen ohne sie ins Leere). | Niedrig | S | Ja: Plausible-UI + Entscheidung | [ANALYTICS-V2.md](plans/ANALYTICS-V2.md) § 5 |
