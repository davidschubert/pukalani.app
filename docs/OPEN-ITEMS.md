...
**Stand: 7 offen · 2 geparkt/wartend · 13 bewusst zurückgestellt** (Zahlen bei JEDEM Umzug nach COMPLETE mitführen)
...
| 13 · NAV1 | **Navigation anpassen — vier Entscheidungen GEFALLEN 2026-09-08 (DECISION-LOG), Paket 1 LIVE.** Befund: der Navigations-Editor war auf branding.supply leer (brand registriert nichts in `chrome.nav`, nur Rechtsseiten als CMS) und wirkungslos (einziger Leser = blueprint-Layout; `BwSiteNav` feste Liste; Silo-PATCH 404). **Paket 1 (Wording „Website-Einstellungen" im Silo, `instanceTabs` an in branding + portfolio) auf main (4a4e8d7f).** **Paket 2 FREIGEGEBEN + GEMERGT 2026-09-08** (Unterpunkte, Standard-Gruppen aus dem Bauplan, Silo-Ablage `instance`, EIN Composable `useCommunityNav`; Details + Gelernt in COMPLETE): branding.supply zeigt „Products → Brand Score · Discover Brands · About · Team" — LIVE seit Build f668a705, Klick hinter dem Login bewiesen (Editor zeigt die Vorgabe, Kopf zeigt den Aufklapper). **Paket 3 offen:** Reihenfolge der Dashboard-Navigation je Person (Prefs), gilt für alle Sites. KOMPLETTE TESTRUNDE 2026-09-08 grün (live Silo per Klick, Pool per Skript 87/61/49 — Details COMPLETE). Nebenbefund „Sucheintrag"/„Weiterleitungen" Silo-404 BEHOBEN 2026-09-08 (cec4173d, live geklickt: Weiterleitung /nav-test ⇒ 301, danach entfernt; Sucheintrag speichert). Neu aufgefallen: die BESCHREIBUNG aus dem Sucheintrag liest nur die Pool-Startseite (apps/platform), auf Silo-Sites mit eigener Startseite wirkt nur `noindex` — Entscheidung offen, ob die Community-Beschreibung dort die Seiten-Beschreibung überschreiben soll. | Hoch | M je Paket | Ja: Freigabe Paket 2 am Prototyp | [NAVIGATION-UNTERPUNKTE.md](archiv/NAVIGATION-UNTERPUNKTE.md) |
| 11 · BD1 | **Brand Design (Produkt 02) — Strategie FREIGEGEBEN 2026-09-07 (vier Entscheidungen, zwei gegen die Empfehlung: fünf Schritte tief, KI-Bildlogos als dritte Zeichen-Stufe), KONZEPT GESCHRIEBEN 2026-09-07 (§2: sechs Kapitel als Schicht 2, Visual-DNA-Vokabulare, Preset-Vertrag zur Themes-Engine, Zeichen in drei Stufen inkl. Core-Bild-Transport mit Leitplanken, Szenen-Vorschau, Freischaltung brand-020, Pakete D0–D9) — KONZEPT FREIGEGEBEN 2026-09-07 (§2.19 nach Empfehlung), PROTOTYP GEBAUT 2026-09-08 (acht Screens im Playground 3009, echte Schriften + echte Ramp-Mathematik, Beweis ohne Konsolen-Fehler; Plan §3) — Prototyp-Abnahme LÄUFT (Korrekturen 2026-09-08 eingebaut: Abstände, Bühne 72 rem, Raster, Farb-Picker). **NEU 2026-09-08 (David, DECISION-LOG): Kapitel 1 nimmt Vorbilder je Bereich (Screenshots) als zweite Quelle, die KI liest sie gegen die Foundation (was trägt, was besser geht); Brand Design wird eigenständiges Produkt neben der Foundation — Konzept §2.2/§2.8 ergänzt, Paket D2 erweitert (Core `aiVision`, brand-022). Prototyp-Nachtrag (Weiche, Upload, Lesung, Ergebnis-Board) GEBAUT und ABGENOMMEN 2026-09-08 (inkl. Hell/Dunkel-Vergleich in der Farbwelt). PROTOTYP FREIGEGEBEN 2026-09-08 (Phase 4) ⇒ Pakete D0–D9 (§2.18) verbindlich; Vision/Bild über OpenRouter mit ZDR-Filter entschieden. **D0 Verträge GEBAUT + GEPRÜFT 2026-09-08** (2 300 Tests, 118/118 Zusagen, sichtbares Verhalten unverändert). **D1 Freischaltung + Rail + Frida GEBAUT + GEPRÜFT 2026-09-08** (2 303 Tests, 139/139 Zusagen), im Worktree, NOCH NICHT auf main: LIVE 2026-09-08 (brand-022 gefahren, Build 3146ff0e). D2a LIVE 2026-09-08 (brand-024 gefahren, Build 2ba83cf3). **D2b Lesung GEBAUT + GEPRÜFT 2026-09-08** (2 368 Tests, 189/189 Zusagen, Core `aiVision` mit festem ZDR-Filter) — LIVE 2026-09-08 (Build 700a9345); Vision-Modell google/gemini-2.5-flash als Build-Default gesetzt (DECISION-LOG) — echter Lauf noch zu prüfen. Inhalts-Gate offen: Fridas Steckbrief, Info-Layer, Karten-Texte der Weiche, Präfix „Bekannt:". **D2c DNA/Boards/Mix/Szene GEBAUT + GEPRÜFT 2026-09-08** (2 450 Tests, 213/213 Zusagen, echter Lauf Vision + DNA ok, drei Klemmen aus dem Klick). Inhalts-Gate zusätzlich: „George, entwirf das" in Design-Kapiteln, Board-Namen/Notizen. D2c LIVE (Build 7a732363). **D3 Farbwelt GEBAUT + GEPRÜFT 2026-09-08** (2 483 Tests, 232/232, eigener Klick Hex + Picker). Inhalts-Gate zusätzlich: Rollen-Namen, Kandidaten-Begründungen, Kontrast-Absage-Satz. D3 LIVE (Build 1612d6d7). **D4 Typografie GEBAUT + GEPRÜFT 2026-09-08** (2 518 Tests, 249/249, Klick per getComputedStyle). D4 LIVE (Build 6774928b). **D5a+b Zeichen GEBAUT + GEPRÜFT 2026-09-08** (2 551 Tests, 274/274, Klick an SVG-Attributen). D5a+b LIVE (Build 3b07b7d6). **D6 Bildsprache GEBAUT + GEPRÜFT 2026-09-08** (2 580 Tests, 295/295, Klick an stroke-width). David hat entschieden: Bild-Modell gemini-2.5-flash-image-preview, brand-023 darf nach D5c-Prüfung laufen. D6 LIVE (Build 79597706). **D5c KI-Entwürfe GEBAUT + GEPRÜFT 2026-09-08** (326/326, echter Bildlauf unter ZDR mit gemini-2.5-flash-image: vier PNG), brand-023 auf Prod gefahren. D5c LIVE (Build 9a30e0ba). **D7 Bewegung GEBAUT + GEPRÜFT 2026-09-09** (2 615 Tests, 352/352, Klick an --ds-dur) — alle sechs Werkstatt-Kapitel stehen. D7 LIVE (Build 18446e05). **D8 Kapitel 10 + Board + Snapshot v2 + Beispiel GEBAUT + GEPRÜFT 2026-09-09** (2 646 Tests, 381/381, Share 47/47). Offene Frage für David: Design-Werte im Snapshot doppelt (Preset + rohe Slot-Werte) — sollen die sechs Kapitel aus `chapters` fallen? D8 LIVE (Build 0cc71026). **D9 Gesamtbeweis GEBAUT + GEPRÜFT 2026-09-09** (verify-brand-design 117/117, Gegenprobe fällt; Sessions 383/383; Share 47/47; 2 651 Tests) — **alle Pakete D0–D9 gebaut.** Davids vier Fragen ENTSCHIEDEN 2026-09-09 (DECISION-LOG), Nachschnitt „Snapshot ohne rohe Design-Werte" gebaut + geprüft (Share 51/51, Design 130/130). AUDIT 2026-09-09 ohne hohe Befunde (Archiv), A1 GEBAUT + GEPRÜFT (IP-Eimer Briefing, Vision-Eingangsklemme, GDPR-Purges rot bei Fehler, Burst-Deckel). NÄCHSTES: **Davids Abnahme** (Inhalts-Gates D1–D8, Liste in der Sitzung), dann COMPLETE + Plan ins Archiv. Geparkt: `aiComplete` loggt Anbieter-Rumpf (Text-Weg).** Erste bezahlte Ableitung: aus der Foundation eine visuelle Identität als Design-System (Moodboard/Visual DNA → Farbwelt mit Ramp + Kontrast → Typografie-Paar → Zeichen → Bild/Motion als Regeln), begründet statt gewürfelt; nutzt Themes-Engine (Ramp, Kontrast, Schriftpaare, Font-Upload), Wortmarken-Generator und den G4-Katalog als Einstieg. Konkurrenz: Logo-Generatoren (Looka, Brandmark, LogoAI, Tailor Brands), freie Werkzeuge (Huemint, Fontjoy, Realtime Colors), Container (Canva, Frontify). Entscheidungen in §1.11, Konzept in §2. | Mittel | XL | Ja: Prototyp-Abnahme; später Inhalte (Fridas Leitern), Bild-Anbieter/ZDR, Prod-Migrationen | [BRAND-DESIGN.md](plans/BRAND-DESIGN.md) |
...
| BI1 | 5 — Wochen | **Brand Insights — redaktioneller Bereich. Prototyp I0 FREIGEGEBEN 2026-09-08** („so bauen" — Phase 4 durch). Konzept ENTSCHIEDEN 2026-09-08 (acht Fragen, Plan §11; abweichend nur der **Themenradar: jetzt**, §9.6), Prototyp-Runde 1 entschieden (fünf Fragen, §11.2 — Beleg-Riegel nach `core`, Radar-Zahl auf 100 mit Fussnote, Redaktion auf drei Adressen). **I1a (Beleg-Riegel nach `core`) läuft.** **Bau I1+ wartet trotz Freigabe auf DB1 + Anwalt + Google-API-Schlüssel (David)** — die Freigabe gilt der FORM, nicht dem Startschuss. Mitentschieden: Plausible für branding.supply (Schalter = BS1 **R2c**, Zeile `12 · BS1`). **DB1-Befund: Slug-Umbenennung ohne 301/Historie, s. Plan §9.2.** | Mittel | L | **Ja: API-Schlüssel, Plausible-Site, Anwalt** | [BRAND-INSIGHTS.md](plans/BRAND-INSIGHTS.md) |
| PS1 | 6 — Tage | **Products-Seite auf branding.supply** — Übersicht + eine Marketing-Seite je Produkt (sieben Namen aus den Manifesten), je Produkt **Preis oder Erstgespräch**. Der Nav-Punkt „Products" kehrt **erst mit den Seiten** zurück (Regel des 404-Audits in `BwSiteNav.vue`: nur echte Ziele). Davor eine kurze Konzeptrunde zu Texten und Reihenfolge. (Davids Entscheidung 2026-09-08, DECISION-LOG.) | Niedrig | M | **Ja: Texte, Preise** | BI1 (kommt danach) |
...
- **Strang „Brand System" nach dem Brand-Check (Davids Entscheidung
  ...
  (URL-/Asset-Extraktion als Relaunch-Einstieg) → Produkt 03 Book & Kit inkl.
  „Brand Context" (brand.md/brand.json/Tokens)**. Bewusst KEINE eigenen P-Nummern für den
