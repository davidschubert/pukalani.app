...
| 6 · U2 | **[AP1] Ehrlich sagen, dass Gründen einen Code braucht — und das Tor bekommt einen Schalter.** Entschieden 2026-08-10: die Code-Pflicht bleibt, bis David sie selbst abschaltet — künftig per An/Aus-Schalter im Betreiber-Dashboard, nicht per Deploy. Die Landing liest den Schalter **dynamisch** (SSR-gecacht; unbekannt ⇒ Einladungs-Variante) und Anmeldeformular/Startseite sagen vorab: Mitmachen steht jedem offen, eine **eigene** Community braucht (derzeit) eine Einladung. | Hoch | M | Nein (entschieden) | [UX-Trichter K1](archiv/audits/2026-08-09-ux-trichter.md) · [Wettbewerb 2.2](archiv/audits/2026-08-09-wettbewerb-benchmark.md) |
