...
| 23 · U20 | **Community-Export** — der Owner lädt seine Community gebündelt herunter. **Zuschnitt ENTSCHIEDEN 2026-08-12:** Inhalte (Beiträge, Kommentare, Seiten, Events/Kurse-Struktur) + Team (Name+Rolle) als JSON/ZIP — **ohne Mitglieder-PII**, gewöhnliche Mitglieder nur als anonyme Zähler. Löst das gesenkte /wechseln-Versprechen ein. | Mittel | M | Nein (entschieden) | [Wettbewerb K4, V5](archiv/audits/2026-08-09-wettbewerb-benchmark.md) · DECISION-LOG 2026-08-12 |
| 24 · U19 | **„Hilf uns, Pukalani zu schärfen"-Karte** hinter dem Aha-Moment (Benchmark E5). **Leser ENTSCHIEDEN 2026-08-12:** Antworten landen im Control Plane, Auswertungs-Seite (Verteilungen) unter admin.pukalani.app — David ist der Empfänger. Freiwillig, nach den ersten Erfolgen im Dashboard. | Niedrig | S–M | Nein (entschieden) | [Wettbewerb E5](archiv/audits/2026-08-09-wettbewerb-benchmark.md) · DECISION-LOG 2026-08-12 |
