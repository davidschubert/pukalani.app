...
| 6 · BW1 | **Brand-Wizard Phase 1 „Fundament".** KI-Markenberater „George" (Layer `brand`) auf pukalani.studio (Projekt `portfolio`), später branding.supply (Domain registriert 2026-08-27): Fundament frei (Beta per E-Mail-Code), Ableitung bezahlt. Produktentscheidungen komplett, zwei Code-Audits eingearbeitet (§9c/§9d); Launch-Gates: A1-AVV, P0-Interaktionsbilanz, P1a-Schema-Anhang. | Mittel | XL (P0–P3 mehrere Wo.) | Ja: Freigeben, P0 + Schema-Anhang gegenlesen | [BRAND-WIZARD-PHASE-1.md](plans/BRAND-WIZARD-PHASE-1.md) |
