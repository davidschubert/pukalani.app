...
| BI1 | 5 — Wochen | **Brand Insights — redaktioneller Bereich. Konzept ENTSCHIEDEN 2026-09-08** (acht Fragen, Plan §11; abweichend nur der **Themenradar: jetzt**, mit vier YouTube-Policy-Leitplanken, §9.6). **Prototyp I0 GEBAUT (2026-09-08)** — läuft auf **Port 3013** (`pnpm --filter @pukalani/insights dev`), sechs Bildschirme, Vertrag + 48 Tests, Plan §9.10; **offen ist Davids Abnahme** (fünf Fragen dort). Bau I1+ wartet auf **DB1** + **Anwalt** + **YouTube-API-Schlüssel (David)**. Mitentschieden: Plausible für branding.supply (Schalter = BS1 **R2c**, Zeile `12 · BS1`). **DB1-Befund: Slug-Umbenennung ohne 301/Historie, s. Plan §9.2.** | Mittel | L | **Ja: API-Schlüssel, Plausible-Site, Anwalt, I0-Abnahme** | [BRAND-INSIGHTS.md](plans/BRAND-INSIGHTS.md) |
