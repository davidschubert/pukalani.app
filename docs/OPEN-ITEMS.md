...
| 10 · DB1 | **Discover Brands — D0–D3 LIVE 2026-09-08 + Nachzüge (Branche im Dialog, Sichtbarkeit bei neuem Stand); Details COMPLETE.** Krume & Gold öffentlich unter `/discover/krume-gold` mit Branche „Lebensmittel und Getränke". OFFEN: **D4** Ähnliche/Sitemap/OG-Bild je Anatomie · **D5** Beispiel-Branding „Kailua Coffee Co." über den Wizard (Davids Konto) · Freigabe-Klick GEKLÄRT 2026-09-08: im sauberen Test (neuer Tab, keine Fernsteuerung) kamen Freigeben, Brand of the Day und Beispiel-Schalter alle an — die zwei verlorenen Klicks davor waren der mit der Fernsteuerung geteilte Chrome-Tab. Nebenbefund: Nuxt-UI `UDashboardSearchButton` rendert das Kürzel `⌘k` client-seitig (SSR „ k") — ein Hydration-Mismatch auf JEDER Dashboard-Seite, Nuxt-UI-Bestand. Rechtstexte (A1) = Gate für die Öffnung an Fremde. | Mittel | M (Rest) | Ja: Klick-Test im neuen Tab, D5-Wizard-Lauf | [DISCOVER-BRANDS.md](plans/DISCOVER-BRANDS.md) |
