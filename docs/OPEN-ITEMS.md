...
| F7 | 3 — Wochen | **Bezahlte Communities** — der Owner nimmt Geld von seinen Mitgliedern. **Das Konzept STEHT** (2026-08-15): [F7-PAID-COMMUNITIES-KONZEPT.md](plans/F7-PAID-COMMUNITIES-KONZEPT.md) — Empfehlung Connect/direct charges, Umsatzsteuer-Befund Art. 9a (wir sind vermutlich in JEDER Variante USt.-Schuldner), Entitlements auf dem bestehenden A5/M13-Bau. **Schluckt D1.** Offen: Davids vier Entscheidungen (§ 8) + Anwaltsliste (§ 9); Bau erst nach A2. | Mittel | XL | Ja: 4 Entscheidungen + Anwalt | Davids Entscheidungen · A2 (Stripe live) |
