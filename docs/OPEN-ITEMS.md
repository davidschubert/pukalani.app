...
| 10 · DB1 | **Discover Brands — D0–D3 LIVE 2026-09-08, erste Freigabe durch (Krume & Gold öffentlich unter `/discover/krume-gold`); Details COMPLETE.** Galerie `/discover` (Facetten Weiche/Archetyp/Farbwelt/Branche, Sortierung, Featured), Anatomie mit Snapshot-Kapiteln/Markenabdruck/Ähnlichen/Melden/Teilen, Veröffentlichen-Dialog mit Freigabe-Zuständen, Betreiber-Seite `/dashboard/discover` (Warteschlange, Freigeben/Ablehnen/Ausblenden mit Begründung, genau ein Featured, Beispiel-Schalter, Meldungen), Migration brand-020 gefahren. OFFEN: **D4** Ähnliche/Sitemap/OG-Bild je Anatomie · **D5** Beispiel-Branding „Kailua Coffee Co." über den Wizard (Davids Konto) · Nachzüge: Branche im Veröffentlichen-Dialog aus dem Katalog wählen (Freitext ⇒ „Nicht zugeordnet"), Log-Zeilen ohne Profil-/Zeilen-Id; BEOBACHTEN: Davids erster Klick auf „Freigeben" erreichte den Server nicht (kein Request), der Klick über die Seite danach schon — Ursache offen. Rechtstexte (A1) = Gate für die Öffnung an Fremde. | Mittel | M (Rest) | Ja: D5-Wizard-Lauf, Freigabe-Klick erneut beobachten | [DISCOVER-BRANDS.md](plans/DISCOVER-BRANDS.md) |
