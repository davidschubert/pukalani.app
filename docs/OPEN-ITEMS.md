...
| 10 · AH-6 | **F3: comments zieht in den Pool.** PLAN LIEGT VOR (2026-08-12) und wartet auf Davids Abnahme — Empfehlung: Pool-Community im Projekt account, apps/comments bleibt als Code der E2E-Anker (photos-Muster); 10 Entscheidungen im Plan nummeriert. Danach: genau zwei Auth-Welten (account + admin); portfolio bleibt Davids Silo. | Mittel | XL | Ja: Plan-Abnahme | [F3-COMMENTS-POOL.md](plans/F3-COMMENTS-POOL.md) |
