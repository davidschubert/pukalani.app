...
**Stand: 18 offen · 6 geparkt/wartend · 10 bewusst zurückgestellt** (Zahlen bei JEDEM Umzug nach COMPLETE mitführen)
...
wird am Stück gebaut (Planungsrunde 2026-08-10; die sechs Entscheidungen dazu
stehen im [DECISION-LOG](DECISION-LOG.md) und sind in den Zeilen vermerkt).
...
| 4 · U18 | **[AP1] Erst messen, dann umbauen.** Vordefinierte Analytics-Ereignisse für den Anmelde-Trichter (Registrierung, Code-Tor, Wizard-Schritte, Anlegen, Checkliste) — vorgezogen aus F47, damit die Wirkung der Trichter-Pakete messbar wird (Ghost misst 26 % statt 7 %; wir messen heute nichts). Muss VOR U1–U4 live sein, sonst fehlt der Vorher-Wert. | Hoch | S | Nein | [ANALYTICS-V2.md](plans/ANALYTICS-V2.md) · [Wettbewerb M2](archiv/audits/2026-08-09-wettbewerb-benchmark.md) |
| 5 · U1 | **[AP1] Wer keine Einladung hat, sitzt fest.** Nach der Anmeldung ohne Code steht dort ein Satz („Schreib uns, wofür du Pukalani nutzen willst") — ohne Knopf, ohne Adresse, ohne Abmelden, ohne Rückweg. Die Anfrage-Seite gibt es, sie ist von dort nur nicht verlinkt. Wer einer Einladungs-Mail folgt und schon angemeldet ist, landet ebenfalls woanders. | Hoch | S | Nein | [UX-Trichter K2, M2](archiv/audits/2026-08-09-ux-trichter.md) |
| 6 · U2 | **[AP1] Ehrlich sagen, dass Gründen einen Code braucht — und das Tor bekommt einen Schalter.** Entschieden 2026-08-10: die Code-Pflicht bleibt, bis David sie selbst abschaltet — künftig per An/Aus-Schalter im Betreiber-Dashboard, nicht per Deploy. Startseite und Anmeldeformular sagen vorab: Mitmachen steht jedem offen, eine **eigene** Community braucht (derzeit) eine Einladung. | Hoch | M | Nein (entschieden) | [UX-Trichter K1](archiv/audits/2026-08-09-ux-trichter.md) · [Wettbewerb 2.2](archiv/audits/2026-08-09-wettbewerb-benchmark.md) |
| 7 · U3 | **[AP1] Wer kaufen will, landet im Passwortfeld.** „Personal holen", „Pro holen", „Interesse anmelden" und „Early Access anfragen" führen alle vier auf die Anmeldung — ohne jeden Bezug zu dem, was der Besucher gerade wollte. Die Seite zum Anfragen ist von der Marketing-Seite nirgends verlinkt, ein Anmelde-Link für Bestandskunden fehlt ganz. | Hoch | S | Nein | [UX-Trichter K3](archiv/audits/2026-08-09-ux-trichter.md) |
| 8 · U4 | **[AP2] Die ersten Minuten in der neuen Community sind leer.** Der frisch angelegte Owner wird mit „Willkommen **zurück**" begrüßt, sieht lauter Nullen. Soll: Startliste mit höchstens fünf Schritten (optional inkl. „@handle wählen"), ein erster Beispiel-Inhalt, eine Mail mit der Adresse der Community. Dazu: die gesäte Startseite in **beide** Sprachen (Trichter M4). Ghost misst dafür **26 % statt 7 %** Abschluss. | Hoch | M | Nein | [UX-Trichter G1, G2, G6, M4](archiv/audits/2026-08-09-ux-trichter.md) · [Wettbewerb E1, E2](archiv/audits/2026-08-09-wettbewerb-benchmark.md) |
| 9 · U5 | **[AP3] Ein Tippfehler im Community-Namen bleibt für immer.** Der Name wird einmal im Wizard gesetzt und ist danach für niemanden mehr änderbar — auch nicht für uns. Er steht im Menükopf, im Browser-Tab, im Vorschaubild und als Absender jeder Mail. Soll: ein Feld „Name und Beschreibung" dort, wo man es sucht; die Adresse bleibt unberührt. | Hoch | M | Nein | [UX-Dashboard K1](archiv/audits/2026-08-09-ux-dashboard.md) |
| 10 · F56 | **[AP3] Private Nachrichten sind schwer zu finden.** Der Einstieg „Nachricht schreiben" neben dem Autorennamen ist im Konzept § 1 zugesagt; `MessageWriteButton.vue` ist gebaut, aber **nirgends verdrahtet**. Heute führt nur der Posteingang hin. | Mittel | S — Knopf im blueprint andocken | Nein | [PN-Konzept § 1](plans/PRIVATE-NACHRICHTEN-KONZEPT.md) |
| 11 · U6 | **[AP4] Ein Wort je Sache.** Entschieden 2026-08-10: das Geld-Wort ist **„Plan"** („Abo" nur für den Vertragszustand, „Tarif" fliegt — löst den Widerspruch der zwei Audits). Dazu englisch „products" statt „blocks", im Betreiber-Menü Community statt Tenant/Mandant. Rund 40 Textstellen, kein Code. | Mittel | M | Nein (entschieden) | [UX-Trichter § 3](archiv/audits/2026-08-09-ux-trichter.md) · [UX-Dashboard § 3](archiv/audits/2026-08-09-ux-dashboard.md) |
| 12 · U7 | **[AP5] Das Menü aufräumen.** 27 Einträge in sieben Gruppen, drei davon mit einem einzigen Eintrag — und für Moderatoren gibt es keine Gruppe „Moderation": ihre vier Arbeitsflächen liegen unter „Produkte" und „Einstellungen". Im Silo heißt der Sammelpunkt „Community-Einstellungen" und enthält „System". Soll: eine Gruppe je Aufgabe, dazu ein Suchfeld. | Mittel | M | Nein | [UX-Dashboard G1, G5, G8](archiv/audits/2026-08-09-ux-dashboard.md) · [Wettbewerb E8](archiv/audits/2026-08-09-wettbewerb-benchmark.md) |
...
| --- | --- | --- | --- | --- | --- | --- |
| U14 | 1 — Tage | **Anmelden mit Google.** Entschieden 2026-08-10: nur Google (Apple kostet 99 $/Jahr Developer-Programm). Braucht im Bau: eine erklärte Datenschutz-Zeile neben „kein Werbe-Tracking" und die Circle-Falle (Social-Login fällt anderswo auf eigenen Kunden-Domains dauerhaft aus) von Anfang an mitgedacht. | Mittel | M | Nein (entschieden) | AP1–AP8 |
| U15 | 2 — Tage | **Die zugesagten Dashboard-Seiten, die es nicht gibt** — allen voran „Navigation" (der Owner stellt das Menü seiner eigenen Community zusammen) und „SEO". Entschieden 2026-08-10: bleibt geparkt bis AP1–AP8 durch sind; dann zuerst „Navigation". | Mittel | L | Ja: Zuschnitt je Seite | AP1–AP8 · [UX-Dashboard § 5](archiv/audits/2026-08-09-ux-dashboard.md) · [DASHBOARD-IA.md](plans/DASHBOARD-IA.md) |
| F57 | 3 — Tage | **Die drei sozialen Mechaniken aus dem Discussions-Konzept Teil 4** — Emoji-**Reaktionen**, **Einladungen durch Mitglieder**, **Tages-Limit für Likes** — plus **Themen-Verlinkung mit Rückverweis**; an ihnen hängen sechs fehlende Abzeichen. Entschieden 2026-08-10: bleibt geparkt bis AP1–AP8; dann Reaktionen zuerst. | Mittel | L | Ja: Rest-Zuschnitt | AP1–AP8 · [DISCUSSIONS-KONZEPT.md](plans/DISCUSSIONS-KONZEPT.md) Teil 4 |
...
| F3 | 5 — Wochen | **Silo → Pool:** `comments` und `portfolio` laufen als eigene Instanzen. Langfristig ist der Pool das Produkt, Silo bleibt das Enterprise-Angebot. | Niedrig | XL | Ja: strategisch | eine strategische Entscheidung |
| F47 | 6 — Tage | **Analytics v2, Rest = nur noch Optionales** (Pakete 1–4 live seit 2026-08-04): Adblock-Proxy · Plausible-Mail-Reports. Die vordefinierten Trichter-Events sind als **U18** in die Hauptliste vorgezogen (2026-08-10). Nichts davon drängt. | Niedrig | je S–M | Nein | [ANALYTICS-V2.md](plans/ANALYTICS-V2.md) |
