...
| 9 · MV1 | **Marktvergleich — M1–M6 GEBAUT und auf main; Prod-Migrationen brand-018/019 + market-001…004 auf branding GEFAHREN (2026-09-06, Davids Ja), Gate-Flip f7bd9fe4 deployt.** Rauchtest in Prod von David BESTANDEN (2026-09-06), Seiten abgenommen. Offen: (1) Bibliothek: bezahlter Lauf GESTARTET (Davids Ja 2026-09-06), dann Handprüfung ([MARKTVERGLEICH-BIBLIOTHEK.md](runbooks/MARKTVERGLEICH-BIBLIOTHEK.md)) + Rechts-Check (Plan Anhang G); (2) BC1: `runBrandCheck()` exportieren, geteilten Mehrseiten-Abruf übernehmen. Danach Plan ins Archiv. | Mittel | M | Ja: Rauchtest + Abnahme, Ja Bibliotheksläufe, Rechts-Check | [BRAND-MARKTVERGLEICH.md](plans/BRAND-MARKTVERGLEICH.md) · [Einführung](runbooks/MARKTVERGLEICH-EINFUEHRUNG.md) · [Bibliothek](runbooks/MARKTVERGLEICH-BIBLIOTHEK.md) |
