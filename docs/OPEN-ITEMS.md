...
| F57 | 3 — Tage | **Die sozialen Mechaniken aus dem Discussions-Konzept Teil 4.** GEBAUT: Emoji-**Reaktionen** (2026-08-13), **Einladungen durch Mitglieder** (2026-08-14, `promoter`) und das **Tages-Limit für Likes** (2026-08-14, 50/Tag, UTC-Tag, keine Erstattung — bringt Out of Love/Higher Love/Crazy in Love). Offen: **Themen-Verlinkung mit Rückverweis**. | Mittel | M | Ja: Reaktionen auf Antworten? + Campaigner/Champion (brauchen die Vertrauensstufe der Eingeladenen — eigener Verleihungs-Pfad) | [DISCUSSIONS-KONZEPT.md](plans/DISCUSSIONS-KONZEPT.md) Teil 4/5 |
