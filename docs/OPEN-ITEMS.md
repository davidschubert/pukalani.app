...
| F57 | 3 — Tage | **Die sozialen Mechaniken aus dem Discussions-Konzept Teil 4.** **Alle vier Mechaniken GEBAUT** (2026-08-13/14): Emoji-**Reaktionen**, **Einladungen durch Mitglieder** (`promoter`), **Tages-Limit für Likes** (staffelt seit F57-Stufen mit der Vertrauensstufe: 50/50/75/100) und die **Themen-Verlinkung mit Rückverweis** (`first-link`). **Campaigner/Champion sind seit 2026-08-14 gebaut** (Aufstieg des Eingeladenen zählt beim Einladenden, `invitedBy` an der Zähler-Zeile, posts-021). Offen nur noch Davids Frage: Reaktionen auch auf Antworten? | Mittel | S | Ja: Reaktionen auf Antworten? | [DISCUSSIONS-KONZEPT.md](plans/DISCUSSIONS-KONZEPT.md) Teil 4/5 |
