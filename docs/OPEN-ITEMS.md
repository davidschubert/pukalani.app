...
| 9 · MV1 | **Marktvergleich — M1–M6 GEBAUT und auf main; Prod-Migrationen brand-018/019 + market-001…004 auf branding GEFAHREN (2026-09-06, Davids Ja), Gate-Flip f7bd9fe4 deployt.** Offen: (1) Rauchtest in Prod mit Davids Konto nach Runbook [MARKTVERGLEICH-EINFUEHRUNG.md](runbooks/MARKTVERGLEICH-EINFUEHRUNG.md) §4 + Seiten-Abnahme Markt/Bot-Seite; (2) Ja zu bezahlten Bibliotheksläufen (≈ $0,02 je Marke), dann Handprüfung ([MARKTVERGLEICH-BIBLIOTHEK.md](runbooks/MARKTVERGLEICH-BIBLIOTHEK.md)) + Rechts-Check (Plan Anhang G); (3) BC1: `runBrandCheck()` exportieren, geteilten Mehrseiten-Abruf übernehmen. Danach Plan ins Archiv. | Mittel | M | Ja: Rauchtest + Abnahme, Ja Bibliotheksläufe, Rechts-Check | [BRAND-MARKTVERGLEICH.md](plans/BRAND-MARKTVERGLEICH.md) · [Einführung](runbooks/MARKTVERGLEICH-EINFUEHRUNG.md) · [Bibliothek](runbooks/MARKTVERGLEICH-BIBLIOTHEK.md) |
