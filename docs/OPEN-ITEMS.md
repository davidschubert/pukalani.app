...
| BI1 | 5 — Wochen | **Brand Insights — redaktioneller Bereich (früher „Journal“, umbenannt 2026-08-30).** Redaktionskonzept ENTSCHIEDEN 2026-09-07 (zwölf Entscheidungen, §1); **Konzeptrunde GESCHRIEBEN 2026-09-08**: §9 hält die Vorschläge (eigener Layer `insights` wie `market` · Adressen `/insights` + `/brands/<slug>` + `/duels/` + `/rankings/` + `/topics/` · Datenmodell mit drei Tabellen · Dashboard mit deterministischer Beleg-Prüfung · Launch-Paket · Pakete I0–I6), §10 **acht Entscheidungsfragen — offen**. Wartet weiter auf **DB1** (D4/D5) + **Anwalt** (§4.3; die YouTube-Frage ist geschärft: die API-Policies untersagen das AGGREGIEREN von API-Daten, also genau unsere Schutzmaßnahme). | Mittel | L | **Ja: die acht Fragen in §10** | [BRAND-INSIGHTS.md](plans/BRAND-INSIGHTS.md) |
