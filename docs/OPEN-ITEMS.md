...
| 9 · MV1 | **Marktvergleich — Strategie + Konzept FREIGEGEBEN (2026-09-05); Prototyp M0 gebaut (Playground 3012); Runde 1 erweitert (§7): Motor = Marktprofil, Ansichten = Brand-Check (EXISTIERT, BC1 — wird wiederverwendet, kein zweiter Score) + Marktvergleich in der Werkstatt („Markt"); vier Quellen inkl. Bibliothek + Opt-in-Marken (Opt-in = Brand-Check-Ranking-Semantik); Sitemap/llms.txt/Mehrseiten als GETEILTE Abruf-Erweiterung mit BC1 abstimmen; KI-Außensicht in Phase 1 mit Konsens-Filter. Prototyp M0b LÄUFT.** Danach Davids Prototyp-Abnahme ⇒ Pakete M1–M6. Abhängig von 8 · BC1 (Abruf, Opt-in, Score-Anbindung). | Mittel | L | Ja: Prototyp abnehmen | [BRAND-MARKTVERGLEICH.md](plans/BRAND-MARKTVERGLEICH.md) |
