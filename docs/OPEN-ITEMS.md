...
| 8 · MV1 | **Marktvergleich — Strategie + Konzept GESCHRIEBEN (2026-09-05, Davids Startwort), wartet auf Freigabe.** Wettbewerber-Websites in die Foundation-Feldstruktur übersetzen (Belegpflicht je Aussage), Konventionen/Überschneidungen/freie Stellen, Befunde am eigenen Feld; kein Ranking, keine Vergleichs-Claims (§ 6 UWG), TDM-Opt-out respektieren. Sieben Entscheidungen offen (§6). Danach Prototyp M0. | Mittel | L | Ja: Strategie freigeben + 7 Fragen | [BRAND-MARKTVERGLEICH.md](plans/BRAND-MARKTVERGLEICH.md) |
