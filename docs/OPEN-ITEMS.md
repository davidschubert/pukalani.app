...
| 4 · AU1 | **Einladungs-Pfad härten** (Audit 2026-08-15, seit F57 jeder Viewer erreichbar): (1) `already_member`-Orakel schließen (Quota verbrauchen ODER ununterscheidbar antworten — Zuschnitt bei David), (2) `invitedByName` in der Mail auf eine Zeile klemmen + Länge begrenzen, (3) unbestätigte E-Mail darf nicht einladen, (4) Quota-Route: role-only-Modus + Drossel. | Hoch | S/M | Kurz: Orakel-Zuschnitt | [AUDIT-2026-08-15.md](archiv/audits/AUDIT-2026-08-15.md) Schnitt B |
