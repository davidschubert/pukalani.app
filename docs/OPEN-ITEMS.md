...
| 11 · BD1 | **Brand Design (Produkt 02) — Strategie FREIGEGEBEN 2026-09-07 (vier Entscheidungen, zwei gegen die Empfehlung: fünf Schritte tief, KI-Bildlogos als dritte Zeichen-Stufe), KONZEPT GESCHRIEBEN 2026-09-07 (§2: sechs Kapitel als Schicht 2, Visual-DNA-Vokabulare, Preset-Vertrag zur Themes-Engine, Zeichen in drei Stufen inkl. Core-Bild-Transport mit Leitplanken, Szenen-Vorschau, Freischaltung brand-020, Pakete D0–D9) — Konzept-Freigabe + drei Fragen (§2.19) offen.** Erste bezahlte Ableitung: aus der Foundation eine visuelle Identität als Design-System (Moodboard/Visual DNA → Farbwelt mit Ramp + Kontrast → Typografie-Paar → Zeichen → Bild/Motion als Regeln), begründet statt gewürfelt; nutzt Themes-Engine (Ramp, Kontrast, Schriftpaare, Font-Upload), Wortmarken-Generator und den G4-Katalog als Einstieg. Konkurrenz: Logo-Generatoren (Looka, Brandmark, LogoAI, Tailor Brands), freie Werkzeuge (Huemint, Fontjoy, Realtime Colors), Container (Canva, Frontify). Entscheidungen in §1.11, Konzept in §2. | Mittel | XL | **Ja: Konzept-Freigabe + §2.19 (Bild-Anbieter/ZDR, Freischaltung, Kapitel-Namen)** | [BRAND-DESIGN.md](plans/BRAND-DESIGN.md) |
