...
| 4 · W1 | **Studio-Funnel: Erstgespräch-Wizard** auf pukalani.studio (Vorbild tobiasnase.de, 2026-08-21 analysiert): 5-Schritte-Vorqualifizierung → cal.com-Sofortbuchung, Plausible-Events als Funnel-Messung (CE ohne Funnels-UI), danach Startseiten-Ausbau (Problem-Spiegel, Vergleichstabelle, Selbst-Selektion). | Mittel | M je Paket | Ja: 4 Entscheidungen im Plan (Budget-Spannen, Telefon optional, Sofortbuchung, Speicherung) | [STUDIO-ERSTGESPRAECH-FUNNEL.md](plans/STUDIO-ERSTGESPRAECH-FUNNEL.md) |
