...
| 9 · MV1 | **Marktvergleich — M1 bis M6 GEBAUT.** M6 ist das Bibliotheks-WERKZEUG (`market-library-compute.mjs`: Machbarkeits-Trockenlauf, Rechnen, Übernahme), das Handprüfungs-Runbook und der Rechts-Check (Anhang G) — der Inhalt fehlt noch. Offen: **Prod-Migrationen `market-001…004` + `brand-018/019` auf `branding`** und danach der Gate-Flip `pukalani.market.enabled`, **Seiten-/Klick-Abnahme durch David**, **Ja für bezahlte Bibliotheksläufe** (~$0,21 für neun Marken), **Handprüfung der Einträge**, **Rechts-Check mit einem Anwalt** (sechs Fragen in Anhang G). | Mittel | M | Ja: Prod-Migrationen, Seiten-Abnahme, bezahlte Läufe, Anwalt | [BRAND-MARKTVERGLEICH.md](plans/BRAND-MARKTVERGLEICH.md) · [Einführung](runbooks/MARKTVERGLEICH-EINFUEHRUNG.md) · [Bibliothek](runbooks/MARKTVERGLEICH-BIBLIOTHEK.md) |
