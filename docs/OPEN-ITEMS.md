...
| BI1 | 5 — Wochen | **Brand Insights — redaktioneller Bereich (früher „Journal“, umbenannt 2026-08-30).** **Redaktionskonzept ENTSCHIEDEN 2026-09-07** (Davids zwölf Entscheidungen — Formate, Produktion, Sprache, Autor, Rhythmus, Quellen, Bewertung, Technik, Ziele, Bilder, Korrekturweg, Reihenfolge): Plan [BRAND-INSIGHTS.md](plans/BRAND-INSIGHTS.md) §1. Wartet auf **DB1** + **Anwalt** (vier neue Fragen, §4.3) + **YouTube-API-Zugang**; Klickdummy im brand-Playground. | Mittel | L | Ja: Konzeptrunde (§8) | [BRAND-INSIGHTS.md](plans/BRAND-INSIGHTS.md) |
