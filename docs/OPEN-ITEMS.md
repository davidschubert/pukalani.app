...
| 12 · BS1 | **branding.supply: Rechtstexte + Bezahlweg — 8 Entscheidungen GEFALLEN (2026-09-07), in Umsetzung.** Texte in den `pages`-Layer, Generator-Entwurf + Anwaltsprüfung, Einmalpreis je Branding über Stripe, Beta-Konten frei. **R0 läuft** (der 404 am Erstgespräch-Knopf verschwindet), **nächstes R1** — `pages` montieren, dafür **Migrationen auf `branding` = Davids Ja**. Gates: Generator-Texte (David) · Anwaltstermin (David) · `4 · A2` für Z1. Vorbedingung fürs Öffnen der Beta. | **Hoch** | M | Ja: Migration, Texte, Anwalt, Preis | [BRANDING-SUPPLY-RECHT-UND-BEZAHLUNG.md](plans/BRANDING-SUPPLY-RECHT-UND-BEZAHLUNG.md) |
