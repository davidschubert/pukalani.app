...
| --- | --- | --- | --- | --- | --- |
| AW2 | **Appwrite 2.0 — Server und SDKs, IN ARBEIT (2026-09-08, Davids Entscheidung: alles in einem Vorhaben).** Reihenfolge: node-appwrite 28 + Code (Health→REST, `users.createJWT`) ⇒ Dev-Server 2.0 ⇒ Prod-Server 2.0 (Downtime-Fenster) ⇒ node-appwrite 29 + appwrite 27 + CI-Appwrite 2.0. Patches (SMTP-KeepAlive, Traefik-XFF) wandern mit. | Hoch | M | Go fürs Prod-Fenster | DECISION-LOG 2026-09-08 |
