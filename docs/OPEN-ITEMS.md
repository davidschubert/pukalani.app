...
| 9 · MV1 | **Marktvergleich — Strategie + Konzept FREIGEGEBEN (David 2026-09-05, 8 Entscheidungen nach Empfehlung). Phase 3 Prototyp M0 LÄUFT** (packages/market/.playground, echte Nuxt-UI, erfundene Wettbewerber-Seiten). Danach Davids Prototyp-Abnahme ⇒ Pakete M1–M5 (§5). Kern: Behauptungs-Raum mit Zitat+Quelle, kein Ranking, § 6 UWG- und TDM-Verträge. | Mittel | L | Ja: Prototyp abnehmen | [BRAND-MARKTVERGLEICH.md](plans/BRAND-MARKTVERGLEICH.md) |
