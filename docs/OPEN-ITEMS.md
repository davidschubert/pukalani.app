...
| 8 · BC1 | **Brand-Check als Produktseite — Konzept + 4 Entscheidungen FREIGEGEBEN 2026-09-05, in Umsetzung.** `/brand-check` (heute 404) mit Reitern Start/Ranking/Vergleich, Teaser zeigen nur noch dorthin; Ranking nur mit Opt-in des Prüfers, Branche per KI + Korrekturvorschlag-Workflow (schlank im brand-Layer), Quartett-Vergleich, „Meine Brands" mit Neu-Ermitteln (10/Tag je Konto) + Gegenüberstellung + To-dos, Dokument-Check für Brands ohne Website. Pakete P1–P5 (§9). | Hoch | L | Ja: Migration brand-017, Texte gegenlesen | [BRAND-CHECK-SEITE.md](plans/BRAND-CHECK-SEITE.md) |
