...
| 10 · BD1 | **Brand Design (Produkt 02) — Strategie FREIGEGEBEN 2026-09-07 (vier Entscheidungen, zwei gegen die Empfehlung: fünf Schritte tief, KI-Bildlogos als dritte Zeichen-Stufe), Konzeption ist dran.** Erste bezahlte Ableitung: aus der Foundation eine visuelle Identität als Design-System (Moodboard/Visual DNA → Farbwelt mit Ramp + Kontrast → Typografie-Paar → Zeichen → Bild/Motion als Regeln), begründet statt gewürfelt; nutzt Themes-Engine (Ramp, Kontrast, Schriftpaare, Font-Upload), Wortmarken-Generator und den G4-Katalog als Einstieg. Konkurrenz: Logo-Generatoren (Looka, Brandmark, LogoAI, Tailor Brands), freie Werkzeuge (Huemint, Fontjoy, Realtime Colors), Container (Canva, Frontify). Entscheidungen in §1.11; nächste Phase Konzeption (§2): DNA-Datenmodell, Preset-Vertrag zur Themes-Engine, Sessions der Schicht 2, Zeichen-Stufen mit KI-Bildlogo-Leitplanken, Vorschau-Szenen, Freischaltung, Pakete. | Mittel | XL | Ja: Konzept-Freigabe, dann Prototyp-Abnahme | [BRAND-DESIGN.md](plans/BRAND-DESIGN.md) |
