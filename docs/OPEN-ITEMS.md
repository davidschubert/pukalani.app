...
| F57 | 3 — Tage | **Die sozialen Mechaniken aus dem Discussions-Konzept Teil 4.** GEBAUT: Emoji-**Reaktionen** (2026-08-13, nur am Thema) und **Einladungen durch Mitglieder** (2026-08-14, 5/Woche + Owner-Schalter + Abzeichen `promoter`). Offen: **Tages-Limit für Likes**, **Themen-Verlinkung mit Rückverweis**; daran hängen vier fehlende Abzeichen. | Mittel | M | Ja: Reaktionen auf Antworten? + Campaigner/Champion (brauchen die Vertrauensstufe der Eingeladenen — eigener Verleihungs-Pfad) | [DISCUSSIONS-KONZEPT.md](plans/DISCUSSIONS-KONZEPT.md) Teil 4/5 |
