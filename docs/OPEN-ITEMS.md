...
| F57 | 3 — Tage | **Die sozialen Mechaniken aus dem Discussions-Konzept Teil 4.** Emoji-**Reaktionen** sind GEBAUT (2026-08-13, nur am Thema — die Antwort-Ebene braucht eine Eigentums-Entscheidung, s. Details). Offen: **Einladungen durch Mitglieder**, **Tages-Limit für Likes**, **Themen-Verlinkung mit Rückverweis**; daran hängen fünf fehlende Abzeichen. | Mittel | M | Ja: Reaktionen auf Antworten? + Rest-Zuschnitt | [DISCUSSIONS-KONZEPT.md](plans/DISCUSSIONS-KONZEPT.md) Teil 4/5 |
