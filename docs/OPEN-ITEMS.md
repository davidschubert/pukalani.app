...
| 12 · BS1 | **branding.supply: Rechtstexte + Bezahlweg — Strategie + Konzept GESCHRIEBEN 2026-09-07, Entscheidungsrunde (8 Fragen) offen.** Die Site ist öffentlich, nimmt Konten auf und hat weder Impressum noch Datenschutz noch AGB (der Fuß zeigt drei Wörter ohne Link); zugleich gibt es keinen Bezahlweg — die Zuteilung je Branding fehlt und der CTA an der Schranke zeigt auf ein `/erstgespraech`, das dort 404 antwortet. **Vorbedingung fürs Öffnen der Beta** (und für DB1). | **Hoch** | M | Ja: 8 Entscheidungen + Anwalt | [BRANDING-SUPPLY-RECHT-UND-BEZAHLUNG.md](plans/BRANDING-SUPPLY-RECHT-UND-BEZAHLUNG.md) |
