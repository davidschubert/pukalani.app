/**
 * Migration moderation-003: E8 Etappe 3, Phase 2 — `communityId` NEBEN `tenantId`,
 * ADDITIV (reports).
 *
...
console.log(`Migration moderation-003 gegen ${endpoint} / Projekt ${projectId} / DB ${db}`)
...
console.log('✔ Migration moderation-003 fertig — ADDITIV; tenantId fällt erst mit der Aufräum-Migration.')
