...
<template>
  <BwWorkspace brand-title="Schubert UX Studio" content-locale="de">
    <template #rail>
      <BwProgressRail :layers="demoRail" />
    </template>

    <template #default>
      <p class="text-xs uppercase tracking-widest" style="color: var(--bw-muted)">Brand Foundation · Archetyp</p>
