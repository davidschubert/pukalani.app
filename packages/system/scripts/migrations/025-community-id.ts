/**
 * Migration system-025: E8 Etappe 3, Phase 2 — `communityId` NEBEN `tenantId`,
 * ADDITIV (activities, notifications).
 *
...
const TABLES = ['activities', 'notifications']
...
console.log(`Migration system-025 gegen ${endpoint} / Projekt ${projectId} / DB ${db}`)
...
console.log('✔ Migration system-025 fertig — ADDITIV; tenantId fällt erst mit der Aufräum-Migration.')
