/**
 * Migration posts-005: E8 Etappe 3, Phase 2 — `communityId` NEBEN `tenantId`,
 * ADDITIV (community_posts, post_votes, poll_votes).
 *
...
const TABLES = ['community_posts', 'post_votes', 'poll_votes']
...
console.log(`Migration posts-005 gegen ${endpoint} / Projekt ${projectId} / DB ${db}`)
...
console.log('✔ Migration posts-005 fertig — ADDITIV; tenantId fällt erst mit der Aufräum-Migration.')
