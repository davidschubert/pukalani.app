/**
 * Migration comments-016: E8 Etappe 3, Phase 2 — `communityId` NEBEN `tenantId`,
 * ADDITIV (comments, guest_authors, comment_votes, embed_sites).
 *
...
const TABLES = ['comments', 'guest_authors', 'comment_votes', 'embed_sites']
...
console.log(`Migration comments-016 gegen ${endpoint} / Projekt ${projectId} / DB ${db}`)
...
console.log('✔ Migration comments-016 fertig — ADDITIV; tenantId fällt erst mit der Aufräum-Migration.')
