/**
 * Migration courses-005: E8 Etappe 3, Phase 2 — `communityId` NEBEN `tenantId`,
 * ADDITIV (courses, lessons, enrollments, lesson_progress).
 *
...
console.log(`Migration courses-005 gegen ${endpoint} / Projekt ${projectId} / DB ${db}`)
...
console.log('✔ Migration courses-005 fertig — ADDITIV; tenantId fällt erst mit der Aufräum-Migration.')
