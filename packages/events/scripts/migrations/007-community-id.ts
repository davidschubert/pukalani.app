/**
 * Migration events-007: E8 Etappe 3, Phase 2 — `communityId` NEBEN `tenantId`,
 * ADDITIV (events, event_rsvps, event_tickets, event_votes).
 *
...
console.log(`Migration events-007 gegen ${endpoint} / Projekt ${projectId} / DB ${db}`)
...
console.log('✔ Migration events-007 fertig — ADDITIV; tenantId fällt erst mit der Aufräum-Migration.')
